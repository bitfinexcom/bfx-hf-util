 ...
 * @param {(
 *   bfx-api-node-models.Candle|
 *   bfx-api-node-models.Candle~Data
 * )} candles - array of ws2/rest2 format candle data
 *
 * @param {boolean} transformed - indicates if the dataset is transformed
 * @returns {Array} consistentCandles
 */
const preprocessRemoteCandles = (tf, candles = [], transformed) => {
...
module.exports = preprocessRemoteCandles
